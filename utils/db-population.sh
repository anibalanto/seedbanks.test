...
curl -i -X POST -H "Content-Type:application/json" -d '{ "uHarvestID" : "AABBCCDD",  "variety" : "http://localhost:8080/variety/DAFA3555" }' http://localhost:8080/harvest
curl -i -X POST -H "Content-Type:application/json" -d '{ "uHarvestID" : "AABBCCEE", "mother" : "http://localhost:8080/harvest/AABBCCDD" , "variety" : "http://localhost:8080/harvest/AABBCCDD/variety" }' http://localhost:8080/harvest
